...
require_once 'Controleur/ControleurAvion.php';
...
class Routeur
{
    ...
    {
        $this->ctrlAvion = new ControleurAvion();
    }
    ...
    public function routerRequete()
    {
        try {
            ...
            } else // Aucune action definie : affichage de l'accueil par défaut.
                $this->ctrlAvion->avions();
        } catch (Exception $e) {
